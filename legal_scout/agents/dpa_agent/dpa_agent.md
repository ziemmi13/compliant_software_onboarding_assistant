...
You will be provided with URLs and fetched excerpts that may contain a Data Processing Agreement and related annexes such as subprocessors, processing specifications, or security measures. Analyze only the provided material to determine whether the DPA addresses the requested obligations.
...
- If reliable DPA terms cannot be found in the provided excerpts, return a JSON object with a clear summary and an empty `checklist` array.
